...
/**
 * VProdukSearch represents the model behind the search form about `app\models\VProduk`.
 */
class VProdukSearch extends VProduk
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['nama_produk', 'deskripsi', 'manufacturer', 'type', 'round', 'foto', 'nama_kategori'], 'safe'],
        ];
    }
